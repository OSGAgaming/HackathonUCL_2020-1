...
namespace HackathonUCL
{
    ...
    public class LocationHost
    {
        ...
        public const int NUMBEROFDATAPOINTS = 480;
        public const float TIMESTEP = 10;

        public static bool IsPlaying;
        public static float StringencyModifier = 1;
        public static float DemocracyModifier = 1;
        ...
        {
            CurrentDate = new DateTime(2020, 2, 24);

            CurrentDate = CurrentDate.AddDays(Time / TIMESTEP);
        }

        public void AppendLocation(string Name, Vector2 position, int Population = 0, string GT = "", float DI = 5f)
        {
